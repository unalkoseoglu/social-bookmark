...
struct FilteredBookmarksView: View {
    ...
    private var filteredBookmarks: [Bookmark] {
        ...
        switch filter {
        case .unread:
            bookmarks = viewModel.allBookmarks.filter { !$0.isRead }
        case .favorites:
            bookmarks = viewModel.allBookmarks.filter { $0.isFavorite }
        case .today:
            bookmarks = viewModel.allBookmarks.filter { Calendar.current.isDateInToday($0.createdAt) }
        }
    ...
    private var filterDescription: String {
        switch filter {
        case .unread:
            return String(localized: "filtered.desc.unread")
        case .favorites:
            return String(localized: "filtered.desc.favorites")
        case .today:
            return String(localized: "filtered.desc.today")
        }
    }
    ...
    private var emptyTitle: LocalizedStringKey {
        switch filter {
        case .unread:
            return "filtered.empty.unread.title"
        case .favorites:
            return "filtered.empty.favorites.title"
        case .today:
            return "filtered.empty.today.title"
        }
    }
    ...
    private var emptyDescription: LocalizedStringKey {
        switch filter {
        case .unread:
            return "filtered.empty.unread.desc"
        case .favorites:
            return "filtered.empty.favorites.desc"
        case .today:
            return "filtered.empty.today.desc"
        }
    }
